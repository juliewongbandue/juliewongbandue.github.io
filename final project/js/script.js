...
$(document).ready(function() {
  ...
  $(".search").submit(function(event) {
    ...
    var matchingResults = ajaxData.filter(function(item) {
      ...
      if (
        itemInfo.name !== "" &&
        itemInfo.name.toLowerCase().indexOf(searchStr) !== -1
      ) {
        return true;
      }
      ...
      if (
        itemInfo.address1 !== "" &&
        itemInfo.address1.toLowerCase().indexOf(searchStr) !== -1
      ) {
        return true;
      }
      ...
      if (
        itemInfo.address2 !== "" &&
        itemInfo.address2.toLowerCase().indexOf(searchStr) !== -1
      ) {
        return true;
      }
    });
    ...
    matchingResults.forEach(function(item) {
      ...
      $museumInfo.append(
        '<h2 class ="museumName raleway">' +
          itemInfo.name +
          "</h2>" +
          '<p class ="openSansCondensed">' +
          itemInfo.address1 +
          "</p>" +
          "<p>" +
          itemInfo.address2 +
